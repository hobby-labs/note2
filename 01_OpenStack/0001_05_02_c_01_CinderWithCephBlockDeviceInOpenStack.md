...
dev-controller01 # openstack server add floating ip

dev-controller01 # openstack floating ip list
+--------------------------------------+---------------------+------------------+--------------------------------------+--------------------------------------+----------------------------------+
| ID                                   | Floating IP Address | Fixed IP Address | Port                                 | Floating Network                     | Project                          |
+--------------------------------------+---------------------+------------------+--------------------------------------+--------------------------------------+----------------------------------+
| e00a2317-af3f-420d-9ea7-c7f3f7cf3b56 | 172.31.230.116      | 192.168.255.106  | 64d71c19-f553-4b78-bddb-a6f09325c4ee | 9a3a1e7b-6e83-45de-b1c9-4d38a46df468 | 0b0120a78ec646fb83a136b28976e284 |
+--------------------------------------+---------------------+------------------+--------------------------------------+--------------------------------------+----------------------------------+

dev-controller01 # # Check floating IP that has no ports
dev-controller01 # openstack floating ip list --network public --long
+--------------------------------------+---------------------+------------------+--------------------------------------+--------------------------------------+----------------------------------+--------------------------------------+--------+-------------+------+----------+------------+
| ID                                   | Floating IP Address | Fixed IP Address | Port                                 | Floating Network                     | Project                          | Router                               | Status | Description | Tags | DNS Name | DNS Domain |
+--------------------------------------+---------------------+------------------+--------------------------------------+--------------------------------------+----------------------------------+--------------------------------------+--------+-------------+------+----------+------------+
| 9cb9c136-3725-4ae3-9b05-7626338cc332 | 172.31.230.129      | None             | None                                 | 9a3a1e7b-6e83-45de-b1c9-4d38a46df468 | 0b0120a78ec646fb83a136b28976e284 | None                                 | DOWN   |             | []   |          |            |
| e00a2317-af3f-420d-9ea7-c7f3f7cf3b56 | 172.31.230.116      | 192.168.255.106  | 64d71c19-f553-4b78-bddb-a6f09325c4ee | 9a3a1e7b-6e83-45de-b1c9-4d38a46df468 | 0b0120a78ec646fb83a136b28976e284 | a95394d5-d305-4199-bed7-10b099e5c731 | ACTIVE | public1     | []   |          |            |
+--------------------------------------+---------------------+------------------+--------------------------------------+--------------------------------------+----------------------------------+--------------------------------------+--------+-------------+------+----------+------------+
